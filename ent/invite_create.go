...
func (_c *InviteCreate) SetUID(v string) *InviteCreate {
	_c.mutation.SetUID(v)
	return _c
}

// SetFamilySpaceID sets the "family_space_id" field.
func (_c *InviteCreate) SetFamilySpaceID(v string) *InviteCreate {
...
func (_c *InviteCreate) SetRevoked(v bool) *InviteCreate {
	_c.mutation.SetRevoked(v)
	return _c
}

// SetNillableRevoked sets the "revoked" field if the given value is not nil.
func (_c *InviteCreate) SetNillableRevoked(v *bool) *InviteCreate {
	if v != nil {
		_c.SetRevoked(*v)
	}
	return _c
...
func (_c *InviteCreate) check() error {
	if _, ok := _c.mutation.UID(); !ok {
		return &ValidationError{Name: "uid", err: errors.New(`ent: missing required field "Invite.uid"`)}
	}
	if _, ok := _c.mutation.FamilySpaceID(); !ok {
		return &ValidationError{Name: "family_space_id", err: errors.New(`ent: missing required field "Invite.family_space_id"`)}
	}
	...
	if _, ok := _c.mutation.Revoked(); !ok {
		return &ValidationError{Name: "revoked", err: errors.New(`ent: missing required field "Invite.revoked"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *InviteCreate) createSpec() (*Invite, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.UID(); ok {
		_spec.SetField(invite.FieldUID, field.TypeString, value)
		_node.UID = value
	}
	if value, ok := _c.mutation.FamilySpaceID(); ok {
		_spec.SetField(invite.FieldFamilySpaceID, field.TypeString, value)
