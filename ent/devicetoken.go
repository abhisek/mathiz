...
type DeviceToken struct {
	...
	// Device token ID (UUID)
	UID string `json:"uid,omitempty"`
	// ChildProfileID holds the value of the "child_profile_id" field.
...
func (*DeviceToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case devicetoken.FieldUID, devicetoken.FieldChildProfileID, devicetoken.FieldFamilySpaceID, devicetoken.FieldTokenHash, devicetoken.FieldDeviceLabel:
			values[i] = new(sql.NullString)
		case devicetoken.FieldLastUsedAt, devicetoken.FieldCreatedAt:
...
func (_m *DeviceToken) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case devicetoken.FieldChildProfileID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field child_profile_id", values[i])
			} else if value.Valid {
				_m.ChildProfileID = value.String
			}
...
func (_m *DeviceToken) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("child_profile_id=")
	builder.WriteString(_m.ChildProfileID)
	builder.WriteString(", ")
